...
export declare type MarkdownContext = {
    component: Component;
};
/** Context need to create dataviews. */
export declare type DataviewInit = {
    app: App;
    index: FullIndex;
...
export declare type DataviewContexts = DataviewInit & {
    component: Component;
};
export declare const DataviewContext: import("preact").Context<DataviewContexts>;
